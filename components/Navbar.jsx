        ...
        <div className='w-full fixed z-10 mb-5 bg-white h-16 flex items-center border-b-2 border-purple-200'>
            ...
            {state ?
                <>
                    ...
                    <Link className='font-bold text-purple-700 text-sm ml-6 hover:text-purple-500' href={"/order"}>Orders</Link>
                    <Link className='font-bold text-purple-700 text-sm ml-6 hover:text-purple-500' href={"/buyer"}>Buyer</Link>
                    <Link className='font-bold text-purple-700 text-sm ml-6 hover:text-purple-500' href={"/seller"} onClick={() => setState(false)}>Switch to Seller</Link>
                </> :
                <>
                    <Link className='font-bold text-purple-700 text-sm ml-16 hover:text-purple-500' href={"/"}>Home</Link>
                    <Link className='font-bold text-purple-700 text-sm ml-6 hover:text-purple-500' href={"/profile"}>profile</Link>
                    <Link className='font-bold text-purple-700 text-sm ml-6 hover:text-purple-500' href={"/seller"}>Seller</Link>
            ...
            <p className='text-purple-700 ml-16'><SiGooglemessages size={30} /></p>
